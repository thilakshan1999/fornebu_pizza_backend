...
public interface OrderRepository extends JpaRepository<Order,Long> {
    ...
    @Query("SELECT new com.redhood.fornebu_pizza_backend.resources.OrderSimpleResource(o.id, o.uid, o.paymentMethod, " +
            "o.isPaid, o.createdAt, o.estimatedTime, o.orderStatus) FROM Order o WHERE o.uid = :uid")
    List<OrderSimpleResource> findSimpleOrdersByUid(Long uid);


    @Query("SELECT new com.redhood.fornebu_pizza_backend.resources.OrderSimpleResource(o.id, o.uid, o.paymentMethod, " +
            "o.isPaid, o.createdAt, o.estimatedTime, o.orderStatus) " +
